...
JsonVariant var6 = doc["parameters"]["variable"]["General"]["m_stop"];
if (!var6.isNull()) this->parameters.variable.General.m_stop = var6.as<uint8_t>();
JsonVariant var7 = doc["parameters"]["variable"]["General"]["m_start"];
if (!var7.isNull()) this->parameters.variable.General.m_start = var7.as<uint8_t>();
...
JsonVariant var13 = doc["parameters"]["variable"]["PositionControl"]["k4"];
if (!var13.isNull()) this->parameters.variable.PositionControl.k4 = var13.as<double>();
