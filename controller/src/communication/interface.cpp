...
JsonObject obj8 = obj7.createNestedObject("signal");
obj8["u"] = this->control.signal.u;
obj8["u_bal"] = this->control.signal.u_bal;
obj8["u_pos"] = this->control.signal.u_pos;
obj8["u_ff"] = this->control.signal.u_ff;
