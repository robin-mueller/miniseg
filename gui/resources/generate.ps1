...
# Load ui files
venv/Scripts/pyside6-uic.exe application/ui/main_window.ui -o resources/main_window_ui.py
venv/Scripts/pyside6-uic.exe application/ui/monitoring_window.ui -o resources/monitoring_window_ui.py
